...
module Aion
  module Integration
    class CustomIdentifierTrackingTest < AionTestCase
      ...
      def create_user(params)
        UserWithCustomIdentifier.create!(params)
      end
      ...
      def test_tracks_create_changes
        ...
        assert_equal 'UserWithCustomIdentifier', changeset.versionable_type
        assert_equal user.username, changeset.versionable_identifier
